...
#define cmd_DayCamera_Zoom_init_default   \
  {                                       \
    0,                                    \
    {                                     \
      cmd_DayCamera_SetValue_init_default \
...
#define cmd_DayCamera_Zoom_init_zero   \
  {                                    \
    0,                                 \
    {                                  \
      cmd_DayCamera_SetValue_init_zero \
...
#define cmd_DayCamera_Root_FIELDLIST(X, a)                                  \
  ...
  X(a, STATIC, ONEOF, MESSAGE,                                              \
    (cmd, set_infra_red_filter, cmd.set_infra_red_filter), 4)               \
  ...
  X(a, STATIC, ONEOF, MESSAGE, (cmd, refresh_fx_mode, cmd.refresh_fx_mode), \
    14)                                                                     \
  X(a, STATIC, ONEOF, MESSAGE,                                              \
    (cmd, set_digital_zoom_level, cmd.set_digital_zoom_level), 15)          \
  X(a, STATIC, ONEOF, MESSAGE, (cmd, set_clahe_level, cmd.set_clahe_level), \
    16)                                                                     \
  X(a, STATIC, ONEOF, MESSAGE,                                              \
    (cmd, shift_clahe_level, cmd.shift_clahe_level), 17)                    \
...
#define cmd_DayCamera_Root_cmd_set_infra_red_filter_MSGTYPE \
  cmd_DayCamera_SetInfraRedFilter
...
#define cmd_DayCamera_Root_cmd_refresh_fx_mode_MSGTYPE \
  cmd_DayCamera_RefreshFxMode
#define cmd_DayCamera_Root_cmd_set_digital_zoom_level_MSGTYPE \
  cmd_DayCamera_SetDigitalZoomLevel
#define cmd_DayCamera_Root_cmd_set_clahe_level_MSGTYPE \
  cmd_DayCamera_SetClaheLevel
#define cmd_DayCamera_Root_cmd_shift_clahe_level_MSGTYPE \
  cmd_DayCamera_ShiftClaheLevel
...
#define cmd_DayCamera_Focus_FIELDLIST(X, a)                            \
  ...
  X(a, STATIC, ONEOF, MESSAGE,                                         \
    (cmd, save_to_table_focus, cmd.save_to_table_focus), 6)
...
#define cmd_DayCamera_Focus_cmd_save_to_table_focus_MSGTYPE \
  cmd_DayCamera_SaveToTableFocus
...
#define cmd_DayCamera_Zoom_FIELDLIST(X, a)                           \
  ...
  X(a, STATIC, ONEOF, MESSAGE, (cmd, halt, cmd.halt), 3)             \
  X(a, STATIC, ONEOF, MESSAGE,                                       \
    (cmd, set_zoom_table_value, cmd.set_zoom_table_value), 4)        \
  X(a, STATIC, ONEOF, MESSAGE,                                       \
    (cmd, next_zoom_table_pos, cmd.next_zoom_table_pos), 5)          \
  X(a, STATIC, ONEOF, MESSAGE,                                       \
    (cmd, prev_zoom_table_pos, cmd.prev_zoom_table_pos), 6)          \
...
#define cmd_DayCamera_Zoom_cmd_set_zoom_table_value_MSGTYPE \
  cmd_DayCamera_SetZoomTableValue
#define cmd_DayCamera_Zoom_cmd_next_zoom_table_pos_MSGTYPE \
  cmd_DayCamera_NextZoomTablePos
#define cmd_DayCamera_Zoom_cmd_prev_zoom_table_pos_MSGTYPE \
  cmd_DayCamera_PrevZoomTablePos
...
#define cmd_DayCamera_SetDigitalZoomLevel_fields \
  &cmd_DayCamera_SetDigitalZoomLevel_msg
#define cmd_DayCamera_Focus_fields &cmd_DayCamera_Focus_msg
#define cmd_DayCamera_Zoom_fields &cmd_DayCamera_Zoom_msg
#define cmd_DayCamera_NextZoomTablePos_fields \
  &cmd_DayCamera_NextZoomTablePos_msg
#define cmd_DayCamera_PrevZoomTablePos_fields \
  &cmd_DayCamera_PrevZoomTablePos_msg
...
#define cmd_DayCamera_SaveToTableFocus_fields \
  &cmd_DayCamera_SaveToTableFocus_msg
...
#define CMD_DAYCAMERA_JON_SHARED_CMD_DAY_CAMERA_PB_H_MAX_SIZE \
  cmd_DayCamera_Root_size
