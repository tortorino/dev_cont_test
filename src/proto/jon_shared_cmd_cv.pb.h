...
typedef struct _cmd_CV_BridgeStart
...
#define cmd_CV_BridgeStart_init_default \
  {                                     \
    0                                   \
  }
#define cmd_CV_BridgeStop_init_default \
  {                                    \
    0                                  \
  }
#define cmd_CV_BridgeRestart_init_default \
  {                                       \
    0                                     \
  }
...
#define cmd_CV_BridgeStart_init_zero \
  {                                  \
    0                                \
  }
#define cmd_CV_BridgeStop_init_zero \
  {                                 \
    0                               \
  }
#define cmd_CV_BridgeRestart_init_zero \
  {                                    \
    0                                  \
  }
...
#define cmd_CV_BridgeStop_FIELDLIST(X, a) X(a, STATIC, SINGULAR, BOOL, force, 1)
