...
/* Metadata for a single video including MOOV data
 Used by both /api/video/meta (full quality) and /api/video/meta-mini (preview
 quality) */
...
#define _jon_video_VideoErrorType_MIN \
  jon_video_VideoErrorType_VIDEO_ERROR_TYPE_UNSPECIFIED
#define _jon_video_VideoErrorType_MAX \
  jon_video_VideoErrorType_VIDEO_ERROR_TYPE_TRUNCATED
#define _jon_video_VideoErrorType_ARRAYSIZE                                       \
  ((jon_video_VideoErrorType)(jon_video_VideoErrorType_VIDEO_ERROR_TYPE_TRUNCATED \
                              + 1))
...
#define jon_video_VideoMetaRequest_init_default \
  {                                             \
    0,                                          \
    {                                           \
      jon_video_VideoRangeQuery_init_default    \
    }                                           \
  }
#define jon_video_VideoIdList_init_default \
  {                                        \
    {                                      \
      { NULL }, NULL                       \
    }                                      \
...
#define jon_video_VideoMetaRequest_init_zero \
  {                                          \
    0,                                       \
    {                                        \
      jon_video_VideoRangeQuery_init_zero    \
    }                                        \
  }
#define jon_video_VideoIdList_init_zero \
  {                                     \
    {                                   \
      { NULL }, NULL                    \
    }                                   \
