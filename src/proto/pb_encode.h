...
extern "C"
{
   ...
   * The actual struct pointed to by src_struct must match the description in
   * fields. All required fields in the struct are assumed to have been filled
   * in.
   *
   * Example usage:
   *    MyMessage msg = {};
...
bool pb_encode_svarint(pb_ostream_t *stream, int32_t value);
   ...
   */
  bool
  pb_encode_string(pb_ostream_t *stream, const pb_byte_t *buffer, size_t size);
